      ...
      <div className="current">
        <ul className="current__info">
          <li className="current__info-item">
            ...
            <span className="current__info-item-units current__info-item-units--wind">
              m/s
            </span>
          </li>
          <li className="current__info-item">
            Humidity: {this.props.data.humidity}
            <span className="current__info-item-units current__info-item-units--humidity">
              %
            </span>
          </li>
          <li className="current__info-item">
            Pressure: {this.props.data.pressure.toFixed(0)}
            <span className="current__info-item-units current__info-item-units--pressure">
              hPa
            </span>
          </li>
        </ul>
